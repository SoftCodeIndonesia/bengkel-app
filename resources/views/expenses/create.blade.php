            ...
            <form action="{{ route('expenses.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <select name="payment_method" id="payment_method" required
                            class="bg-gray-700 border border-gray-600 text-white rounded-md shadow-sm py-2 px-3 w-full focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                            <option value="cash" {{ old('payment_method', 'cash') == 'cash' ? 'selected' : '' }}>Tunai
                            </option>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="bg-gray-700 border border-gray-600 text-white rounded-md shadow-sm py-2 px-3 w-full focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('description') }}</textarea>
                </div>
