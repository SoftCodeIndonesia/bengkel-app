...
@section('content')
    <div class="bg-gray-800 rounded-lg shadow overflow-hidden border border-gray-600">
        <div class="p-4 flex justify-between items-center border-b border-gray-600">
            <h2 class="text-xl font-semibold text-white">Ubah Data Kendaraan</h2>
            ...
            <form action="{{ route('vehicles.update', $vehicle->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="merk" id="merk" value="{{ old('merk', $vehicle->merk) }}"
                    ...
                    <div>
                        <label for="tipe" class="block text-sm font-medium text-gray-300 mb-2">Tipe <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="tipe" id="tipe" value="{{ old('tipe', $vehicle->tipe) }}"
                    ...
                    <div>
                        <label for="no_pol" class="block text-sm font-medium text-gray-300 mb-2">Nomor Polisi <span
                                class="text-red-500">*</span></label>
                        <input type="text" name="no_pol" id="no_pol" value="{{ old('no_pol', $vehicle->no_pol) }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="hidden" name="customer_id" value="{{ $vehicle->customers()->first()->id }}">
                            <input type="text" id="search-dropdown" readonly name="customer_name"
                                value="{{ $vehicle->customers()->first()->name }}"
