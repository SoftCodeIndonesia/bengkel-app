            ...
            <form action="{{ route('sales.update', $sale->id) }}" method="POST" id="salesForm">
                ...
                <div class="w-full mb-6">
                    ...
                    <div class="relative w-full">
                        <input type="hidden" name="customer_id" value="{{ old('customer_id', $sale->customer_id) }}" />
                        <input type="text" id="customer_name" value="{{ old('customer_name', $sale->customer_name) }}"
                            name="customer_name"
                ...
                <div class="mb-6">
                    ...
                    <textarea type="text" name="notes" id="notes"
                        class="mt-1 block w-full bg-gray-700 text-white border border-gray-600 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">{{ old('notes', $sale->notes) }}</textarea>
                    @error('notes')
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function addItemRow(productId, productName, grade, kategori, unit_price, dicount_percentage) {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-3 text-center grade">
                        ${grade}
                    </td>
            ...
            document.getElementById('confirm-selection').addEventListener('click', function() {
                ...
                checkboxes.forEach(checkbox => {
                    ...
                    const productName = productRow.querySelector('td:nth-child(2)')
                        .textContent;
                    const grade = productRow.querySelector('td:nth-child(3)')
                        .textContent;
                    const productPrice = productRow.querySelector('td:nth-child(4)')
                        .textContent;
